...
function extractColumns(
  ...
  // Pull values at indexes from each row (mutates rows, like lodash _.pullAt)
...
export default function loadCSV(
  ...
  // Parse numeric values and apply converters (skip header row)
  ...
  if (shuffle) {
    // Seeded shuffle to get deterministic results
    const seed = "phrase";
